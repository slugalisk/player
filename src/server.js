...
var NginxInjector = require('./NginxInjector');

var _dht = require('./dht');

var dht = _dht;

var _ppspp = require('./ppspp');
...
function generateId(addr) {
  ...
  const prefix = new hilbert.Hilbert2d(1).xy2d(Math.round(((parseFloat(location.longitude) || 0) + 180) * 100), Math.round(((parseFloat(location.latitude) || 0) + 90) * 100));
